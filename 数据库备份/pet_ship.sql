...
CREATE TABLE `adopt` (
  ...
  `is_del` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '0' COMMENT '逻辑删除，默认0，填充删除日期',
...
CREATE TABLE `appointment` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `is_del` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '0' COMMENT '逻辑删除，默认0，填充删除日期',
